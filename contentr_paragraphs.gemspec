...
require "contentr_paragraphs/version"

# Describe your gem and declare its dependencies:
Gem::Specification.new do |s|
  s.name        = "contentr_paragraphs"
  s.version     = ContentrParagraphs::VERSION
  s.authors     = ["Philipp Hirsch"]
  s.email       = ["itself@hanspolo.net"]
  s.homepage    = "https://github.com/metaminded/contentr_paragraphs"
